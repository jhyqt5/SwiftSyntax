...
class Peach {
    ...
    static let varieties = ["round", "donut", "white"]
...
let goldenPeach = Peach(variety: "round", softness: 3)
goldenPeach.ripen()
...
let lilly = FluffyDog(name: "Lilly", fluffiness: 5, droolFactor: 1)
lilly.cudability
lilly.chase("toyota")
...
let koa = ChattyDog(name: "Koa", breed: "Pom", size: .Small)
koa.bark()
//: __4c.__
